...
export class Executor {
     ...
     */
    async raceProviders(providers, messages, ctx) {
        const startTime = Date.now();
        try {
     ...
     */
    async tryProvidersSequential(providers, messages, ctx) {
        let lastError;
     ...
     */
    async callProvider(provider, messages, ctx) {
     ...
     */
    processProviderResult(result, ctx, providerId) {
     ...
     */
    async executePlanning(step, ctx) {
     ...
     */
    async executeReflection(step, ctx) {
     ...
     */
    calculateCostSavings(providerId, tokens) {
